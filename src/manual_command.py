...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.groupBox.setGeometry(QtCore.QRect(width(20), height(20), width(1200), height(400)))
        font = QtGui.QFont()
        ...
        self.pushButton.setStyleSheet("QPushButton{border:3px solid black; border-radius:10px;}")
