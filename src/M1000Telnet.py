...
#             self.telnet.write(bytes(self.username, 'utf-8') + bytes(self.newline, 'utf-8'))
#             self.telnet.read_until(b'Password: ')
#             self.telnet.write(bytes(self.password, 'utf-8') + bytes(self.newline, 'utf-8'))
#             print('client connected')
#             value = self.telnet.read_until(b">")
#             if "Logged" in str(value):
#                 self.global_connection = True
#         except ConnectionError:
#             print(e)
#             self.global_connection = False
#
#     def getCommand(self, tab_id: str):
#         cyclic_time = time.time() + 20
#         try:
#             while time.time() < cyclic_time and not self.global_connection:
#                 self.connection()
...
#         except ConnectionError:
#             print(e)
#         self.telnet.write(b'GET ' + bytes(tab_id, 'utf-8') + bytes(self.newline,'utf-8'))
#         response = self.telnet.read_until(b">")
#         result_value = str(response).split(" ")[2].split("\\")[0]
#         return result_value
#
#     def setCommand(self, tab_id, value):
#         try:
#             self.telnet.write(b'SET ' + bytes(tab_id, 'utf-8') + b' ' + bytes(value, 'utf-8') + bytes(self.newline, 'utf-8'))
#             response = self.telnet.read_until(b">")
#             print(response)
...
#
#     CONNECTION = Telnet(host, "engg1", 'engg123')
#     # CONNECTION.connection()
#     for i in range(4):
#         print(CONNECTION.getCommand("TAB.393.0"))
#     print(CONNECTION.getCommand("TAB.390.0"))
#     print(CONNECTION.getCommand("TAB.394.0"))
#     print(CONNECTION.setCommand("TAB.31.0", '1'))
#     print(CONNECTION.getCommand("TAB.390.0"))
#
#
#
