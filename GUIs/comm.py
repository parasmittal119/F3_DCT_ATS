...
class Ui_load(object):
    def setupUi(self, load):
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 20, 351, 41))
    ...
    def retranslateUi(self, load):
        ...
        self.groupBox.setTitle(_translate("load", "Communication"))
        self.label.setText(_translate("load", "DC Load Comm. Check"))
        self.pushButton.setText(_translate("load", "Check"))
        self.label_2.setText(_translate("load", "TextLabel"))
